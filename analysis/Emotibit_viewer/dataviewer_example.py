...
file_dir = r"D:/sub002/emotibit" # e.g. C:\Users\dev\data  # Ex. C:\Users\dev\data
# specify the base file name of teh parsed data
file_base = r"2024-05-14_12-39-56-615095"  # e.g. 2019-12-10_11-55-54-038975

# arguments for command line
# usernote_toggle False hide_dc EA,ER

hide_DC_tags = ["EA", "SA", "SR", "SF","PI", "PR", "PG", "HR", "TH", "AX", "AY", "AZ", "GX", "GY", "GZ",
						   "MX", "MY", "MZ", "T1", "DC", "DO", "LM"] 
